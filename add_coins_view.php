                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li><a href="add_coins_view.php" class="active"><i class="fa fa-plus" aria-hidden="true"></i> Add Coins</a></li>
                        ...
                        <div class="col-lg-12 col-md-6 col-sm-6 col-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.2s">
                            <div class="features-small-item">
                                <div class="modal-header">
                                    <h4 style="color: purple;"><b>ADD COINS </b></h4>
                                </div>
                       <form class="form-horizontal" method="POST" action="add_coins.php" autocomplete="off">
                                    <div class="form-group ">
                                        <label for="coin" class="col-sm-3 control-label ">ENTER COINS: </label>
                                        <div class="col-sm-12">
                                            <input class="form-control" type="number" name="coin" id="coin" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="type" class="col-sm-3 control-label">FROM: </label>
                                        <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <label for="utr" class="col-sm-3 control-label">UTR: </label>
                                        <div class="col-sm-12">
                                            <input class="form-control" type="text" name="utr" id="utr" minlength="12" maxlength="12" required>
                                        </div>
                                    </div>
                                    <p style="color: red;">*<?php
                                        $conn = $pdo->open();
                                        $stmt = $conn->prepare("SELECT recharge FROM message");
                                        $stmt->execute();
                                        foreach ($stmt as $row) 
                                            if (!empty($row['recharge'])) 
                                            echo $row['recharge'];?></p>
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-primary btn-flat" name="add"><i class="fa fa-plus"></i> ADD</button>
                                    </div>
                                </form>
