  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
              <?php if($admin['game_create']){ ?>
            <div class="box-header with-border">
              <a href="#addnew" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i> New Game</a>
            </div>
              <?php } ?>
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    ...
                    $slno=1;
                    try{
                      $stmt = $conn->prepare("SELECT * FROM game WHERE game_delete='0' AND game_completed='0'");
                      $stmt->execute();
                      foreach($stmt as $row){
