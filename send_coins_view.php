                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li><a href="send_coins_view.php" class="active"><i class="fa fa-paper-plane" aria-hidden="true"></i> Send Coins</a></li>
                        ...
                        <div class="col-lg-12 col-md-6 col-sm-6 col-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.2s">
                            <div class="features-small-item">
                                <div class="modal-header">
                                    <h4 style="color: purple;"><b>PAY TO FRIEND </b></h4>
                                </div>
                                <div class="modal-body">
                                    <form class="form-horizontal" method="POST" action="pay_friend.php" autocomplete="off">
